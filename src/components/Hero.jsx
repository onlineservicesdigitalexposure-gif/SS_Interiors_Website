      ...
      <div className="container-px relative mx-auto grid items-center gap-16 pb-24 lg:grid-cols-[1.1fr_0.9fr] lg:pb-32">
        <div>
          ...
          <motion.h1
            ...
            className="mt-6 break-words font-display text-3xl font-extrabold leading-[1.05] text-bone sm:text-5xl lg:text-6xl"
          >
            Spaces, <span className="text-gradient-bronze">Engineered</span> Beautiful.
          </motion.h1>
          ...
          <motion.p
            ...
            className="mt-6 max-w-lg font-body text-white leading-relaxed text-bone-muted md:text-lg"
          >
